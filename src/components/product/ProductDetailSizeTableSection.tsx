...
type Props = {
  locale: string;
  sizeTable: SizeTable;
  /** Çoklu tabloda üst bölüm başlığı olmadan sadece tablo gövdesi */
  embedded?: boolean;
  /** embedded iken alt başlık (locale metni) */
  blockTitle?: string;
};
...
export default function ProductDetailSizeTableSection({
  ...
  if (embedded) {
    return <div className="pd-size-embedded-block">{tableBlock}</div>;
  }
